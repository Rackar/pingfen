<template>
  <div id="pfresult">
    ...
    <div class="mark">
      <div class="mark">
        <div class="mark-container" style="zoom: 100%;" v-show="showid == 0">
        ...
        <div class="markJury" style="zoom: 80%;" v-if="showid == 3">
          ...
          <div class="bottom">
            ...
            <div class="right">
              <el-scrollbar style="height: 100%;">
                <div class="remark-container" style="margin-top: 0px;" v-for="(item, index) in markObejct.record_jb" :key="index">
                  <!-- //record_jb -->
            ...
            <div class="remark-animation"></div>
          </div>
        </div>
          ...
          <div class="gray-container">
            <div class="toggleBtn">
              <div class="btns" style="left: 0px; margin-left: 0px; margin-right: 0px;">
                ...
                <button type="button" :class="['btn', activeindex == 2 ? 'active' : '']" @click="buttonfensu(2)">现场成绩</button>
              </div>
            </div>
            <div class="result-winner single">
              <div
                :class="['result-item', `rank${index + 1 == 1 ? 2 : index + 1 == 2 ? 1 : index + 1}`]"
                style="order: 1; opacity: 1;"
...
<style lang="stylus">
/* src="./css/pfresult.styl" */
@import './css/pfresult.styl'
</style>
